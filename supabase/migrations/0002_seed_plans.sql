...
values
  ...
  ('individual_semester', 'Individual Semester', 'one_time', 'payment', 5900, 4,
   15, 10, 1, 5,
  ...
  ('individual_annual', 'Individual Annual', 'year', 'subscription', 12900, 12,
   50, 30, 1, 25,
   '{"privateProjects":true,"aiGeneration":true,"privateExport":true,"customThemes":true,"sourceParsing":false,"advancedRevise":false,"teamWorkspace":false}'::jsonb,
  ...
  ('monthly_instructor', 'Monthly Instructor', 'month', 'subscription', 1500, 1,
   12, 8, 1, 5,
   '{"privateProjects":true,"aiGeneration":true,"privateExport":true,"customThemes":true,"sourceParsing":false,"advancedRevise":false,"teamWorkspace":false}'::jsonb,
  ...
  ('designer_pro', 'Designer Pro', 'year', 'subscription', 29900, 12,
   200, 100, 1, null,
  ...
  ('team', 'Team', 'year', 'subscription', 59900, 12,
   600, 300, 5, null,
