...
const buildReviewChecklist = (course: {
  ...
  return [
    ...
    makeReviewItem("must", "Review syllabus policy language", "Institution policies vary and should not be treated as verified by CourseForge.", "Replace placeholders for late work, academic integrity, AI use, accessibility, communication, and support.", "policy"),
